...
class InceptionResnetV2:
	...
	def block35(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
		...
		with tf.compat.v1.variable_scope(scope, 'Block35', [net], reuse=tf.compat.v1.AUTO_REUSE):
	...
	def block17(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
		...
		with tf.compat.v1.variable_scope(scope, 'Block17', [net], reuse=tf.compat.v1.AUTO_REUSE):
			with tf.compat.v1.variable_scope('Branch_0'):
	...
	def block8(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
		...
		with tf.compat.v1.variable_scope(scope, 'Block8', [net], reuse=tf.compat.v1.AUTO_REUSE):
			with tf.compat.v1.variable_scope('Branch_0'):
				tower_conv = slim.conv2d(net, 192, 1, scope='Conv2d_1x1')
			with tf.compat.v1.variable_scope('Branch_1'):
